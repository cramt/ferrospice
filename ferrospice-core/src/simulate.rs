...
pub(crate) fn solve_nonlinear_op(mna: &MnaSystem) -> Result<Vec<f64>, MnaError> {
    ...
    let prev_bsim3soi_pd_voltages =
        std::cell::RefCell::new(vec![(0.0, 0.0, 0.0, 0.0); bsim3soi_pds.len()]);
    ...
    let load = |solution: &[f64], system: &mut LinearSystem, source_factor: f64| {
        ...
        // 6. Stamp BSIM3 companion models.
        {
            let mut prev = prev_bsim3_voltages.borrow_mut();
        ...
        // 7. Stamp BSIM3SOI-PD companion models.
        {
            let mut prev = prev_bsim3soi_pd_voltages.borrow_mut();
        ...
        // 7b. Stamp BSIM3SOI-FD companion models.
        {
            let mut prev = prev_bsim3soi_fd_voltages.borrow_mut();
        ...
        // 8. Stamp BSIM4 companion models.
        {
